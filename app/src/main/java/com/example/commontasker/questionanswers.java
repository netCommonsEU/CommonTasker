...
public class questionanswers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.questionanswers);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();
                startActivity(new Intent(questionanswers.this,maintask.class));
    ...
    public void addListenerOnButton5() {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), answer.class);
                startActivityForResult(intent, 0);
                view.startAnimation(buttonClick);
            }
        });
                ...
                .setPositiveButton("YES",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                finish();
                                Toast.makeText(questionanswers.this,"Successfull Logout",Toast.LENGTH_LONG).show();
                                startActivity(new Intent(questionanswers.this,eggrafh.class));
                            }
                        })
